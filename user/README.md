...
To make `/agent ingest` immediately exercisable, this `user/` folder ships with sample source material. Each file demonstrates a different ingestion shape and exercises a different decision the agent has to make.
